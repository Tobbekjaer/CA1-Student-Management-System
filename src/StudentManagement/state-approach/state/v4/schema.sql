-- The desired state definition of V4 
...
CREATE TABLE dbo.Course (
                            ...
                            InstructorId INT NULL,      -- new column (nullable)
...
CREATE TABLE dbo.Instructor (                                   -- new table
                                Id INT NOT NULL IDENTITY(1,1),
                                FirstName NVARCHAR(100) NOT NULL,
                                LastName NVARCHAR(100) NOT NULL,
                                Email NVARCHAR(255) NOT NULL,
...
CREATE UNIQUE INDEX UX_Instructor_Email                        -- new unique index
...
ALTER TABLE dbo.Course                       -- Foreign key relation
